...
export const Header: FC<HeaderProps> = ({
  ...
  const [modalInitialCache, setModalInitialCache] = useState<
    CacheParameters[] | undefined
  >();
      ...
      <header className="flex pl-4 gap-8 items-center bg-gray-900 text-white">
        ...
        <div className="flex-grow flex gap-4">
          ...
          <Dropdown
            ...
            placement="bottom"
          >
            <Button icon={<Gear size={16} />}>Caches</Button>
          </Dropdown>
          ...
          <Button onClick={onFileManagerClick} icon={<Gear size={16} />}>
            Programs
          </Button>
        </div>
